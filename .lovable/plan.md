...
## Ziel
Die Spalten `text_inhalt` und `text_zusammenfassung` für die Lektion `f10b3df0-1a58-4d2a-80a1-164b38a21292` in der Tabelle `thermocheck.contractor_akademie_lektionen` befüllen.

---

## Die Texte

### text_inhalt (Lerninhalt-Tab)

```markdown
## 1. Das Mindset: „Datenqualität entscheidet über Lebensdauer"
...
### text_zusammenfassung (Zusammenfassung-Tab)

```markdown
## „Deine Arbeit vor Ort ist das Gehirn der späteren Anlage."
...
| Aktion | Details |
|--------|---------|
| Tabelle | `thermocheck.contractor_akademie_lektionen` |
| Lektion-ID | `f10b3df0-1a58-4d2a-80a1-164b38a21292` |
| Spalten | `text_inhalt`, `text_zusammenfassung` |
| Methode | SQL UPDATE via Supabase |
...
Nach dem Update:
- Tab "Lerninhalt" zeigt die 3 Kapitel (Mindset, Datenerfassung, Workflow)
- Tab "Zusammenfassung" zeigt die Kernbotschaft
- Beide Tabs sind nach 90% Video-Watchtime freigeschaltet
